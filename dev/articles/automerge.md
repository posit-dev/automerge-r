...
print(doc)
#> <Automerge Document>
#> Actor: c55f0fe56df8c1df744c97e0d87345a4 
#> Root keys: 0
```
...
#>  [1] 03 49 ea e5 42 e8 4b b8 d2 70 3a 0f da f9 01 30 5e 36 3c 95 be 6c
#> [23] 7b f8 e0 94 73 e1 66 95 83 d2
am_change_message(change)  # Commit message
#> [1] "Set version"
am_change_time(change)     # Timestamp
#> [1] "2026-02-16 15:55:25 UTC"
am_change_seq(change)      # Sequence number
#> [1] 2
am_change_actor_id(change) # Who made the change
#>  [1] fe 64 7e 39 ce b0 99 97 94 82 a9 99 a9 a7 e7 f4
am_change_deps(change)     # Parent change hashes
#> [[1]]
#>  [1] b9 cf 38 af 8c ff 1e 49 cc bf 6a a9 d6 dc 93 04 2e 87 1e 51 67 0d
#> [23] 04 88 eb fa 49 5f 65 1d ae 07
