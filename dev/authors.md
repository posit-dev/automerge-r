...
package version 0.4.0.9000, <https://github.com/posit-dev/automerge-r>.
...
## Additional details
    ...
    Authors of bundled Rust crates:
     ...
     - block-buffer 0.12.0: RustCrypto Developers
     ...
     - typenum 1.20.0: Paho Lurie-Gregg, Andre Bogus
     - unicode-ident 1.0.24: David Tolnay
     - unicode-segmentation 1.13.2: kwantam, Manish Goregaokar
    ...
    (Generated from Cargo.toml files on 2026-05-20)
