...
Building from source requires Rust >= 1.85 ([rustup.rs](https://rustup.rs/)).
...
- [autosync](https://posit-dev.github.io/autosync/) - automerge-repo compatible R sync server and client
